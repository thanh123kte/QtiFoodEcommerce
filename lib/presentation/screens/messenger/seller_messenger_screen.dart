...
class SellerMessengerScreen extends StatefulWidget {
  final String sellerId;

  const SellerMessengerScreen({super.key, required this.sellerId});

  @override
  State<SellerMessengerScreen> createState() => _SellerMessengerScreenState();
}

class _SellerMessengerScreenState extends State<SellerMessengerScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _viewModel.load(widget.sellerId);
    });
  }
        ...
        builder: (_, vm, __) {
          ...
          return Scaffold(
            ...
            body: RefreshIndicator(
              ...
              child: _buildBody(state, vm, context),
            ),
          );
        },
      ),
  ...
  Widget _buildBody(MessengerUiState state, MessengerViewModel vm, BuildContext context) {
    ...
    if (items.isEmpty) {
      return ListView(
        ...
        children: [
          ...
          Text(
            'Khách hàng sẽ liên hệ với bạn tại đây',
            textAlign: TextAlign.center,
  ...
  void _openChat(BuildContext context, ConversationViewData item) async {
    await context.push(
      '/seller/chat',
      extra: {
        'conversationId': item.id,
        'counterpartName': item.title,
        'counterpartAvatar': item.avatarUrl,
      },
    );
...
class _SellerConversationTile extends StatelessWidget {
  final ConversationViewData item;
  final VoidCallback onTap;

  const _SellerConversationTile({required this.item, required this.onTap});
